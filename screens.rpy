...
screen history():
    ...
    tag menu
    add "gui/overlay/history_bg.png"
    ...
    frame:
        ...
        textbutton _("Return") action Return() yalign 1.1 xalign 1.0 xoffset -30 yoffset -30 alt "Return"
